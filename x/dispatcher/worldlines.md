...
- **Merkle DAG Architecture:**  
  - **Events in Leaves:**  
    Events, recorded as leaves in the DAG, represent immutable historical records. They intentionally do not include references to previous events.  This allows events to be inserted, deleted, and reordered on different worldlines.
